...
namespace Azul
{
	...
	class AZUL_ENGINE_LIBRARY_API GraphicsObject_ConstColorLight :public GraphicsObject
	{
	public:
		...
		virtual MaterialKind GetMaterialKind() const override { return MaterialKind::ConstColorLight; }
