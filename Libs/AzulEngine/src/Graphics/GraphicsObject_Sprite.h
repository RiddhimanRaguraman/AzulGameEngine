...
namespace Azul
{
	class AZUL_ENGINE_LIBRARY_API GraphicsObject_Sprite :public GraphicsObject
	{
	public:
		...
		virtual MaterialKind GetMaterialKind() const override { return MaterialKind::Sprite; }
