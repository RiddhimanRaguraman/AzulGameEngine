...
namespace Azul
{
	...
	CompareStrategyBase *TexNodeMan::posEnumNameCompare = nullptr;
	...
	void TexNodeMan::Create(int reserveNum, int reserveGrow)
	{
		...
		{
			posEnumNameCompare = new TexNodeCompareStrategyEnumName();
		}
	}
	...
	void TexNodeMan::Destroy()
	{
		...
		delete TexNodeMan::posEnumNameCompare;
		TexNodeMan::posEnumNameCompare = nullptr;
	...
	TextureObject *TexNodeMan::Find(TextureObject::Name _name)
	{
		...
		// set strategy
		pMan->pCompareStrategy = TexNodeMan::posEnumNameCompare;
